...
- Dedicated servers do not download or render images locally; connected clients handle their own presentation
- No custom per-image network transport is needed — normal UI snapshot/batch sync carries the URL prop
